...
for iter = 1:var_iter_num
    
    ii = randi(10^6, 1)/10^3;
    j1 = randi(10^6, 1)/10^3;
    j2 = randi(10^6, 1)/10^3;
    j3 = randi(10^6, 1)/10^3;
    jj = randi(10^6, 1)/10^3;
    lik = randi(10^6, 1)/10^3;
    ...
    try
        hyp = minimize(hyp, @gp, -gp_iter_num, @infExact, meanfunc, covfunc, likfunc, train_x, train_y);
