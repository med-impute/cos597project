...
from covSEardJoint import *
from medutilDist import *
...
class OurGaussianProcess(BaseEstimator, RegressorMixin):
    ...
    def fit(self, X, y):
        ...
        # TODO: Replace through self-defined distance functions
        ...
        #                     " target value.")
        D, ij = med_cross_distances_test(X)
        if (np.min(np.sum(D, axis=1)) == 0.
                and self.corr != correlation.pure_nugget):
            raise Exception("Multiple input features cannot have the same"
                            " target value.")
    ...
    def predict(self, X, eval_MSE=False, batch_size=None):
        ...
        if batch_size is None:
            ...
            # TODO: overwrite the original distance function and regression model
            ...
            # Get pairwise componentwise L1-distances to the input training set
            dx = med_distance_test(X, Y=self.X)
    ...
    def reduced_likelihood_function(self, theta=None):
        ...
        if D is None:
            # TODO: overwrite the original distance function
